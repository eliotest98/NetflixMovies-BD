...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
 <a class="navbar-brand" href="index.jsp">
    <img src="images/NetflixMovies11.png"  style="width: 250px; height: 110px; padding-bottom: 10px;">
  </a>   
</nav>
  ...
  <label class="form-check-label">
    <input type="radio" class="form-check-input" name="optradio">ALL <%selectionType = 0; %>
  </label>
</div>
<div class="form-check-inline">
  <label class="form-check-label">
    <input type="radio" class="form-check-input" name="optradio">MOVIES <%selectionType = 1; %>
  </label>
</div>
<div class="form-check-inline disabled">
  <label class="form-check-label">
    <input type="radio" class="form-check-input" name="optradio">TV SERIES <%selectionType = 2; %>
  </label>
</div>
	</div>
	<br><br>
